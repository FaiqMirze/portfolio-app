        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7 col-12">
                    <div class="hero-text">
                        <div class="hero-title-wrap d-flex align-items-center mb-4">
                            <img src="{{asset('front/images/happy-bearded-young-man.jpg')}}"
                ...
                <div class="col-lg-5 col-12 position-relative">
                    ...
                    <img src="{{asset('front/images/portrait-happy-excited-man-holding-laptop-computer.png')}}"
            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-12 mx-auto">
                    <div class="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                        <img src="{{asset('front/images/handshake-man-woman-after-signing-business-contract-closeup.jpg')}}"
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="projects-thumb">
                        ...
                        <a href="images/projects/nikhil-KO4io-eCAXA-unsplash.jpg" class="popup-image">
                            <img src="{{asset('front/images/projects/nikhil-KO4io-eCAXA-unsplash.jpg')}}" class="projects-image img-fluid"
                                 alt="">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="projects-thumb">
                        ...
                        <a href="images/projects/the-5th-IQYR7N67dhM-unsplash.jpg" class="popup-image">
                            <img src="{{asset('front/images/projects/the-5th-IQYR7N67dhM-unsplash.jpg')}}" class="projects-image img-fluid"
                                 alt="">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="projects-thumb">
                        ...
                        <a href="images/projects/true-agency-9Bjog5FZ-oc-unsplash.jpg" class="popup-image">
                            <img src="{{asset('front/images/projects/true-agency-9Bjog5FZ-oc-unsplash.jpg')}}"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-8 col-12">
                    <div class="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                        <img src="{{asset('front/images/aerial-view-man-using-computer-laptop-wooden-table.jpg')}}"
                             class="avatar-image img-fluid" alt="">
...
<script src="{{asset('front/js/bootstrap.min.j')}}s"></script>
